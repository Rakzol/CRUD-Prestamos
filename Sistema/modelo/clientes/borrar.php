<?PHP
    /*
        Que hace:
            Borra un cliente en la base de datos ejecutando una consulta a un procedimiento almacenado en la base de datos
        Procedimiento:
    */
    ...
    try
    {
        ...
        $preparada = $conexion->prepare( "CALL borrar_cliente( :rfc );" );
