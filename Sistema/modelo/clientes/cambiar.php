<?PHP
    /*
        Que hace:
            Cambia un cliente en la base de datos ejecutando una consulta a un procedimiento almacenado en la base de datos
        Procedimiento:
    */
    ...
    try
    {
        ...
        $preparada = $conexion->prepare( "CALL cambiar_cliente( :rfc, :nombres, :b_nombres, :apellido_paterno, :b_apellido_paterno, :apellido_materno, :b_apellido_materno, :telefono, :b_telefono, :correo_electronico, :b_correo_electronico, :numero_casa, :b_numero_casa, :calle, :b_calle, :colonia, :b_colonia, :ciudad, :b_ciudad, :estado, :b_estado, :sexo, :b_sexo, :fecha_nacimiento, :b_fecha_nacimiento, :moroso, :b_moroso, :nombre_referencia, :b_nombre_referencia, :telefono_referencia, :b_telefono_referencia, :direccion_referencia, :b_direccion_referencia );" );
