<?PHP
    /*
        Que hace:
            Agrega un abono en la base de datos ejecutando una consulta a un procedimiento almacenado en la base de datos
        Procedimiento:
    */
    ...
    try
    {
        ...
        $preparada = $conexion->prepare( "CALL agregar_abono( :id_vale );" );
