<?PHP
    /*
        Que hace:
            Cambiar un distribuidor en la base de datos ejecutando una consulta a un procedimiento almacenado en la base de datos
        Procedimiento:
    */
    ...
    try
    {
        ...
        $preparada = $conexion->prepare( "CALL cambiar_distribuidor( :rfc, :nombres, :b_nombres, :apellido_paterno, :b_apellido_paterno, :apellido_materno, :b_apellido_materno, :telefono, :b_telefono, :correo_electronico, :b_correo_electronico, :numero_casa, :b_numero_casa, :calle, :b_calle, :colonia, :b_colonia, :ciudad, :b_ciudad, :estado, :b_estado, :limite_credito, :b_limite_credito, :monto_credito, :b_monto_credito );" );
